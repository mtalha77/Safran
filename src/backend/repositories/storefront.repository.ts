...
const ITEM_QUERY =
  "select=id,category_id,item_number,name,description_de,description_en,price,discount_percent,is_active,sort_order,image_path&is_active=eq.true&order=sort_order";
